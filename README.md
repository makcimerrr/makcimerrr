...
**Fullstack developer** — Go backends, TypeScript frontends, and the Docker infrastructure underneath.
Rouen, France.

I ship production software end to end, and I teach other people to do the same.
...
| **Portfolio** | [makcimerrr.com](https://makcimerrr.com) — four themes borrowed from race telemetry | Next.js · TypeScript |

### Stack

```text
Backend    Go · Node.js · Hono · WebSockets
Frontend   TypeScript · React · Next.js · Tailwind · shadcn/ui
Data       PostgreSQL · Redis · SQLite · Drizzle · Prisma
Infra      Docker · Coolify · Traefik · OVH VPS · Linux
AI         Ollama · RAG · Anthropic API
```

### How I work

- Own the whole chain — from the schema to the reverse proxy in production.
- Self-hosted by default. If I depend on it, I want to be able to run it myself.
- Code a teammate can read at 2 a.m. beats code that's clever.

---

Off keyboard: road cycling, endurance racing, and one side project too many.

[makcimerrr.com](https://makcimerrr.com) · [GitHub](https://github.com/makcimerrr)
